...
public:
    ...
    moCap_sub = _nh.subscribe("/RigidBody/odom", 1, &Controller::updateMoCap, this);
		...
		outFile_robotState.open("/home/michael/catkin_ws/etaDeltaTheta20.txt");//DeltaTheta
    ...
    ROS_INFO("Initialize robot");
		...
		inFile_trajectory.open("/home/michael/catkin_ws/src/underwater_simulation/underwater_snakerobot_controller/trajectory/wayPoints4.txt");
		string line;
