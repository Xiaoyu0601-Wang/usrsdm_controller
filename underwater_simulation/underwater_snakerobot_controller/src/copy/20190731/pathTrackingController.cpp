...
public:
    ...
    ,lpf_screwVel1(4.0, 0.01)
    ,lpf_screwVel2(4.0, 0.01)
    ,lpf_jointPos1(10.0, 0.01)
    ...
    moCap_sub = _nh.subscribe("/RigidBody/odom", 1, &Controller::updateMoCap, this);
		...
		outFile_robotState.open("/home/michael/catkin_ws/etaDeltaTheta10_2.txt");//DeltaTheta
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    double C_c = thetaErrorCal(path_posi_temp1[2], path_posi_temp[2])/0.001;
